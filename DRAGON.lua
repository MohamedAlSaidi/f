...
if tonumber(user_id) == tonumber(2091235375) then  
var = true 
...
local UserName = (data.username_ or "X_M_O_D_Y_X")
...
if text == "/start" then
local Namebot = (database:get(bot_id..'Name:Bot') or 'ليون') 
local DRAGON_Msg = { 
...
send(msg.chat_id_, msg.id_,' 🚀 اصدار سورس ليون{ S:12✓}')
end
...
usertext = '\n 🌛 العضو ⤌ ['..data.first_name_..'](t.me/'..(data.username_ or 'X_M_O_D_Y_X')..')'
status  = '\n 🌛 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀 الـعـضو   ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'X_M_O_D_Y_X')..') \n 🚀 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "ليون")
...
send(msg.chat_id_,0," 🚀 الـعـضو  : {["..data.first_name_.."](T.ME/X_M_O_D_Y_X)}\n 🚀 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🚀 عذرا  ↚ {["..data.first_name_.."](T.ME/X_M_O_D_Y_X)}\n 🚀 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if text == 'السورس' or text == 'سورس' or text == '' or text == 'source' then 
local Text = [[
𝐖𝐄𝐋𝐂𝐎𝐌 𝐓𝐎 𝐒𝐎𝐔𝐑𝐂𝐄 𝐋𝐈𝐎𝐍𝐄
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹𝑺 ♪', callback_data="/units"},{text = '•𝑷𝑹𝑶𝑮𝑹𝑨𝑴𝑴𝑬𝑹𝑺♪', callback_data="/theytry"}},   
{{text = '˹𝑪𝑯   𝐋𝐈𝐎𝐍𝐄˼', url="t.me/X_M_O_D_Y_X"}},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/X_M_O_D_Y_X/288&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == 'مين نصبلك' or text == 'عايزه بوت' or text == 'عايز بوت' then
local Text = [[
 ♡ اهلا بك في سورس ليون الجمدان
 لو عايز بوت بأسعار منسبه وبوت مميز كلمني ♡ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '˹E L K E B E R˼', url="t.me/X_ELKHEDIWY_X"},{text = '˹S A S A˼', url="t.me/X_x_sasa_x_X"}},
{{text = '˹M O D Y˼', url="t.me/X_M_O_D_Y_0"}}, 
{{text = '˹𝑪𝑯 ˼', url="t.me/X_M_O_D_Y_X"}},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/X_M_O_D_Y_X/288&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == '𝐕𝘼𝙈𝘽𝙄𝙍' or text == 'مودي الكبير' or text == 'المبرمج مودي الكبير' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
tdcli_function ({ID = "GetUser",user_id_ = 2091235375,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'المبرمج 🌚💘\n['..result.first_name_..'](t.me/X_M_O_D_Y_0)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '  ❨ '..result.first_name_..'  ❩ ',url="t.me/X_M_O_D_Y_0"},
},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 2091235375, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end

if text == 'قناه السورس' or text == 'قناة السورس' or text == '♡━─⊶🚀𝐋𝐈𝐎𝐍𝐄🚀⊷─━♡' then
local Text = [[
لقناة سورس ليون
اتبع الزر إلى تحت ↓
...
if text == 'استوري مودي الكبير' or text == 'كوكب مودي الكبير' or text == 'قناه المبرمج مودي الكبير' or text == 'متيجي' or text == 'متيقي' then
local Text = [[
متيقي هنا دي بقي الكوكب الخاص بالمبرمج مودي الكبير
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝑷𝑳𝑨𝑵𝑬𝑻 Mody🏂💖',url="t.me/X_D_E_V_S"}},
{{text = 'اضف البوت الي مجموعتك ♡ ' ,url="t.me/"..dofile("./Bkar.lua").botUserName.."?startgroup=start"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
[اليك بوتات تحميل 🌜
من جميع المواقع 🌝](t.me/X_M_O_D_Y_X)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
"قد جربت تبكي فرح؟ وليش؟ ",
  ...
  "هل انت حرامي تويت بتعت مودي الكبير؟ ",
...
if text == 'العاب ليون' or text == 'العاب مطوره' or text == 'العاب متطوره' or text == 'العاب' then    
local Text = [[  
 🚀 اهلا في قائمه الالعاب المتطوره سورس ليون 🚀 
...
send(msg.chat_id_, msg.id_, '🚀  مـن قبـل  ↚ [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'X_M_O_D_Y_X')..') \n🚀 تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀 تم تعطيل جلب الصوره \n 🚀 تم قفل البوتات  \n 🚀 تم قفل التكرار ،\n 🚀 تم قفل الروابط ،\n 🚀 تم قفل التوجيه ،\n 🚀 تم قفل الملصقات ،\n 🚀 تم قفل المتحركه ،\n 🚀 تم قفل الفيديو ،\n 🚀 تم قفل الفشار ،\n 🚀 تم قفل الانلاين ،\n 🚀 تم قفل تعديل المديا ،\n 🚀 تم وضع التكرار  ،\n 🚀 تم قفل الفارسيه  ،\n 🚀 تم وضع الايدي بدون صوره ،n  \n 🚀 تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'X_M_O_D_Y_X')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوه من قبل    [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'X_M_O_D_Y_X')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🚀  مـن قبـل  ↚ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'X_M_O_D_Y_X')..') \n 🚀 تـم قفـل التاك بالكتم ')
end,nil)   
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local X_M_O_D_Y_X = database:get(bot_id..'text:ch:user')
if X_M_O_D_Y_X then
send(msg.chat_id_, msg.id_,'['..X_M_O_D_Y_X..']')
else
send(msg.chat_id_, msg.id_,' ♡ لا تستطيع استخدام البوت \n  ♡ يرجى الاشتراك بالقناه اولا \n  ♡ اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
...
if tonumber(result.sender_user_id_) == tonumber(2091235375) then  
send(msg.chat_id_, msg.id_, " ♡ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(2114579189) then  
send(msg.chat_id_, msg.id_, " ♡ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(2057650462) then  
...
if result.id_ == tonumber(2091235375) then
send(msg.chat_id_, msg.id_, " ♡ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(2114579189) then
send(msg.chat_id_, msg.id_, " ♡ لا يمكنك حظر مالك السورس\n")
return false 
end
if result.id_ == tonumber(2057650462) then
send(msg.chat_id_, msg.id_, " ♡ لا يمكنك حظر مطور السورس \n")
return false 
end
usertext = '\n ♡ العضو ← ['..result.title_..'](t.me/'..(username or 'X_M_O_D_Y_X')..')'
status  = '\n ♡ تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if tonumber(userid) == tonumber(2091235375) then  
send(msg.chat_id_, msg.id_, " ♡ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(2114579189) then  
send(msg.chat_id_, msg.id_, " ♡ لا تسطيع حظر مالك السورس عام")
return false 
end
if tonumber(userid) == tonumber(2057650462) then  
send(msg.chat_id_, msg.id_, " ♡ لا تسطيع حظر مطور السورس عام")
return false 
end
...
if Get_info then
local TextS = "\n 🚀 اهلا بك في متجر ملفات ليون\n 🚀 ملفات السورس ↓\n♡━─⊶🚀𝐋𝐈𝐎𝐍𝐄🚀⊷─━♡\n\n"
local TextE = "\n♡━─⊶🚀𝐋𝐈𝐎𝐍𝐄🚀⊷─━♡\n 🚀 علامة تعني { ✔️ } ملف مفعل\n 🚀 علامة تعني { ✖ } ملف معطل\n 🚀 قناة سورس ليون↓\n".." 🚀 [اضغط هنا لدخول](t.me/X_M_O_D_Y_X) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 🚀 عذرا الملف لايدعم سورس ليون\n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'X_M_O_D_Y_X')..')'
status  = '\n 🚀 تم ترقيته مطور'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n 🚀 الـعـضو   ↚ ['..result.title_..'](t.me/'..(username or 'X_M_O_D_Y_X')..')'
status  = '\n 🚀 تم ترقيته مطور'
texts = usertext..status
else
texts = ' 🚀 لا يوجد حساب بهاذا المعرف'
...
if text == ("مسح قائمه ليون") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n 🚀 تم مسح قائمه ليون')
return false
end

if text == 'قائمه ليون' and Sudo(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🚀 لعضو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'X_M_O_D_Y_X')..')'
status  = '\n 🚀 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🚀 الـعـضو   ↚ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🚀 العضــو  ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'X_M_O_D_Y_X')..')'
...
' }\n'..' 🚀  الايدي بالصوره  ↚ { '..idph..
' }\n'..' 🚀  الرفع  ↚ { '..setadd..
' }\n'..' 🚀  الحظر  ↚ { '..DRGm..' }\n\n 🚀♡━─⊶🚀𝐋𝐈𝐎𝐍𝐄🚀⊷─━♡\n 🚀 قناة سورس ليون↓\n [ ❲[𝐒ΘΘ𝐍](t.me/X_M_O_D_Y_X)❳](t.me/X_M_O_D_Y_X) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'♡━─⊶🚀𝐋𝐈𝐎𝐍𝐄🚀⊷─━♡\nاضغط علي الاسم ليتم نسخه\n♡━─⊶🚀𝑭𝑨??𝑻𝑬𝑹🚀⊷─━♡ٴ\n 🚀 ❲[ 𝐋𝐈𝐎𝐍𝐄](t.me/X_M_O_D_Y_X)❳ 🚀 ')
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🚀 الـعـضو   ↚ ['..result.title_..'](t.me/'..(text1[3] or 'X_M_O_D_Y_X')..')'..'\n 🚀 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ليون').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ليون')
local DRAGON_Msg = {
'نعم يروحي 😻🌚',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
...
local Text = '['..AY..'](t.me/X_M_O_D_Y_X)'
keyboard = {}  
keyboard.inline_keyboard = { 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☘️ الـعـضو   ↚ ['..data.first_name_..'](t.me/'..(data.username_ or 'X_M_O_D_Y_X')..') '
...
end --الكود حصري سورس ليونيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ليون').." غادر" or text == 'غادر' then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ليون').." الاحصائيات" or text == 'الاحصائيات' then  
if Sudo(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = ' 🚀 الاحصائيات  \n'..' 🚀 عدد الجروبات  ↚ {'..Groups..'}'..'\n 🚀  عدد المشتركين  ↚ {'..Users..'}'
...
if tonumber(msg.sender_user_id_) == tonumber(2091235375) then
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[رتبتك المبرمج مودي الكبير🥺🤍](t.me/X_M_O_D_Y_X)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
if text == 'رتبتي' then
local msg_id = msg.id_/2097152/0.5  
local textt = '[بنت المبرمج مودي الكبير🥺💘](t.me/X_M_O_D_Y_X)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[المطور الاساسي🥺🤍](t.me/X_M_O_D_Y_X)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[المطور الاساسي²  😍💚](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'رتبتي' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[ المطور 🌝💘](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'رتبتي' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[المالك 🌚💘](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'رتبتي' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[المنشئ اساسي 🤦‍♂️](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'رتبتي' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ المنشئ😂💘](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'رتبتي' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[المدير الجامد😹](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'رتبتي' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[الادمن 😹 ](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'رتبتي' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ المميز حبيبي الكل 😊 ](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'رتبتي' then
send(msg.chat_id_,msg.id_, '[عضو قميل 🌝💘](t.me/X_M_O_D_Y_X)') 
return false
end
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المبرمج نن عيني 🥺🤍](t.me/X_M_O_D_Y_X)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/X_M_O_D_Y_X)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور♡', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🚀](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/X_M_O_D_Y_X)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/X_M_O_D_Y_X)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/X_M_O_D_Y_X)') 
return false
end
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'X_M_O_D_Y_X')..')'
local iduser = result.sender_user_id_
...
keyboard.inline_keyboard = {
{{text = 'E L K E B E R',url="t.me/X_ELKHEDIWY_X"},{text = 'S A S A', url="t.me/X_x_sasa_x_X"}},
{{text = ' بوت شادو',url="t.me/USDDBOT"},{text = 'بوت مودي الكبير', url="t.me/VPllllllllllllbot"}},
...
keyboard.inline_keyboard = {
{{text = '˹ M O D Y ˼',url="t.me/X_M_O_D_Y_0"}},
{{text = '˹ T A W O S L ˼ ',url="t.me/X_D_E_V_S"}}, 
{{text = ' ˹B A C K ˼', callback_data="/HHH"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ليون')
